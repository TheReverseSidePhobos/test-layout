  ...
  return (
    <Layout>
      <Head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Lato:wght@400;700&family=Noto+Serif:ital,wght@0,400;0,700;1,400;1,700&display=swap"
          rel="stylesheet"
        />
      </Head>
      ...
      <div className={'header header_wrapper'}>
        <div className="container main_header">
          <div>
            ...
            <button className={`${'activeBtn'} ${'btn'}`}>Learn more</button>
        ...
        <div className="container">
          ...
          <div className="slider_items ">
            <div className="item">
              ...
              <button>
                <Image src="/arrow.svg" alt="arrow" width={20} height={10} />
                Learn more
              </button>
              <Image
                className="down_img"
